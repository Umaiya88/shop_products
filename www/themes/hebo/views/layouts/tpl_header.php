...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>OTOBI-Changing Lifestyles</title>
    ...
    <link rel="shortcut icon" href="<?php echo $baseUrl;?>/img/ico/icon.jpg">
    
    <link rel="apple-touch-icon-precomposed" href="<?php echo $baseUrl;?>/img/ico/icon.jpg">
  </head>
