...
class ImageController extends Controller
{
	...
	public function actionCreate()
	{
        ...
        if(isset($_POST['Image']))
        {
            ...
            $model->attributes=$_POST['Image'];
 			$path="D:/xampp/htdocs/shop_products/www/";
            ...
            if($model->save())
            {
                $uploadedFile->saveAs($path.'uploads/'.$fileName);
	...
	
	{
        ...
        if(isset($_POST['Image']))
        {
            $_POST['Image']['filename'] = $model->filename;
            $model->attributes=$_POST['Image'];
            ...
            if($model->save())
            {
                ...
                {
                    $uploadedFile->saveAs(Yii::app()->baseUrl.'/uploads/'.$model->filename);
                }
                $this->redirect(array('view','id'=>$model->id));
            }
